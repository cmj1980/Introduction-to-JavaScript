...
Do the following:   
   ...
   HINT: no function required
*/
let firstThing = 'tails'
let secondThing = 'tails'
if (firstThing === secondThing) { 
  firstThing = 'heads'
}
//console.log('task1b', firstThing)
...
console.log(game('task4', "paper", computer))
...
console.log('task6', annoyingSong(9));
